/*
 * Copyright 2022 Drew Noakes and contributors
 *
...
public class TiffReaderContext {
    ...
    private final Set<Integer> _visitedIfds = new HashSet<Integer>();
     ...
     */
    public TiffReaderContext WithByteOrder(boolean isMotorolaByteOrder)
    {
    	_reader.setMotorolaByteOrder(isMotorolaByteOrder);
        return new TiffReaderContext(_reader, isMotorolaByteOrder, _isBigTiff);
    }
